	...
	<body>
		...
		<div id="show-kongJian" class="content scaffold-show" role="main">
			...
			<ol class="property-list kongJian">
				...
				<g:if test="${kongJianInstance?.biaoTi}">
				<li class="fieldcontain">
					<span id="biaoTi-label" class="property-label"><g:message code="kongJian.biaoTi.label" default="Biao Ti" /></span>
					
						<span class="property-value" aria-labelledby="biaoTi-label"><g:fieldValue bean="${kongJianInstance}" field="biaoTi"/></span>
